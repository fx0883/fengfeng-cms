 ...
 * @since 2022-03-11
 */
@ApiModel(value = "Tbl_full_body_workouts_list对象", description = "")
public class Tbl_full_body_workouts_list implements Serializable {
    ...
    public String toString() {
        return "Tbl_full_body_workouts_list{" +
