 ...
 * @since 2022-03-11
 */
@ApiModel(value = "Tbl_shoulder_back_advanced对象", description = "")
public class Tbl_shoulder_back_advanced implements Serializable {
    ...
    public String toString() {
        return "Tbl_shoulder_back_advanced{" +
